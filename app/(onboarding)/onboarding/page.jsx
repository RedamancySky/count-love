...
const themePalette = {
    ...
    blush: { bg: "#fff1f2", accent: "#fb7185", text: "#9f1239" },
    cherry: { bg: "#fecdd3", accent: "#e11d48", text: "#881337" },
    coral: { bg: "#ffe4e6", accent: "#f43f5e", text: "#9f1239" },
    strawberry: { bg: "#fff1f2", accent: "#be123c", text: "#7f1d1d" },
    champagne: { bg: "#fff7ed", accent: "#fb7185", text: "#9d174d" },
};
...
export default function OnboardingPage() {
    ...
    const copy =
        lang === "vi"
            ? {
                  ...
                  welcomeDesc:
                      "6 bước nhanh để cá nhân hóa tài khoản và kết nối với người yêu.",
                  ...
                  completeDesc:
                      "Thiết lập tài khoản đã xong. Bắt đầu vào dashboard.",
                  back: "Quay lại",
                  next: "Tiếp tục",
                  ...
                  roomCreated:
                      "Đã tạo phòng kết nối. Gửi mã cho người yêu để tham gia.",
                  roomJoined: "Đã tham gia phòng thành công.",
                  badImage: "Chỉ chấp nhận file ảnh.",
                  progressDesc:
                      "Hoàn thành từng bước để bắt đầu sử dụng ứng dụng.",
            ...
            : {
                  ...
                  welcomeDesc:
                      "Six quick steps to personalize your account and connect with your partner.",
                  ...
                  joinRoom: "Join room",
                  createRoomHint:
                      "Tap Continue to generate a 6-char code and QR.",
                  inviteCode: "Invite code",
                  waiting:
                      "Waiting for your partner to scan QR or enter code...",
                  ...
                  completeDesc:
                      "Your account setup is done. Enter your dashboard.",
                  back: "Back",
                  next: "Continue",
                  ...
                  roomCreated:
                      "Room created. Share code with your partner to join.",
    ...
    const daysInLove = useMemo(() => {
        ...
        return Math.max(
            0,
            Math.floor((Date.now() - date.valueOf()) / 86400000),
        );
    }, [data.startDate]);
    ...
    function validateCurrentStep() {
        ...
        if (step === 2) {
            if (!data.nickname.trim())
                nextErrors.nickname = copy.nicknameRequired;
    ...
    return (
        <main className="mx-auto w-full max-w-4xl p-4 md:p-8">
            <Card className="border-white/70 bg-white/88 shadow-xl backdrop-blur">
                        ...
                        <section className="grid gap-3">
                            ...
                            <div className="flex flex-wrap gap-2">
                                <Button
                                    type="button"
                                    variant={
                                        data.createRoom ? "default" : "outline"
                                    }
                                    onClick={() => {
                                        setData((s) => ({
                                            ...s,
                        ...
                        <section className="grid gap-3">
                            ...
                            >
                                ...
                                <p className="mt-1 text-xl font-semibold">
                                    {data.coupleTitle || copy.yourCouple}
                                </p>
                                <p className="text-sm">
